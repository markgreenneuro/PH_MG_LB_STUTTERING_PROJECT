...
CONFIG_MAP = {
    't_8': Config(
        ...
        target_params_file='PARAMS/target_params.pkl',
        positive_file='REAL_DATA/real_data_8.npy',
        positive_file_txt='REAL_DATA/real_data_8.txt',
    ...
    't_20': Config(
        ...
        target_params_file='PARAMS/target_params.pkl',
        positive_file='REAL_DATA/real_data_20.npy',
        positive_file_txt='REAL_DATA/real_data_20.txt',
    ...
    't_64': Config(
        ...
        target_params_file='PARAMS/target_params.pkl',
        positive_file='REAL_DATA/real_data_64.npy',
        positive_file_txt='REAL_DATA/real_data_64.txt',
