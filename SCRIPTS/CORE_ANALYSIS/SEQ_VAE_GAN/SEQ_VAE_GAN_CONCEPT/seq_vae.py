...
import configs
from seqgan_encoder import BidirectionalLstmEncoder
from generator import Generator
from rollout import ROLLOUT
from dataloader import Gen_Data_loader, Dis_dataloader
from discriminator import Discriminator
from target_params import *
...
def main():
    ...
    negative_file = 'REAL_DATA/seq_vae_1_' + time_str + '_' + config.negative_file_txt
    eval_file = 'REAL_DATA/eval_file.txt'
    ...
    log_fn = 'REAL_DATA/seq_vae_1_' + time_str + '.log'
